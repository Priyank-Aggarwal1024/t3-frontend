...
export default function ShippingPolicy() {
  ...
  const sections = [
    {
      ...
      icon: <FaTruck className="text-t3_blue" size={24} />,
    },
    {
      ...
      icon: <AiOutlineClockCircle className="text-t3_blue" size={24} />,
    },
    {
      ...
      icon: <FaMapMarkerAlt className="text-t3_blue" size={24} />,
    },
    {
      title: "🎧 Need Assistance?",
      content:
        "For any shipping inquiries, contact our support team. We’re happy to help!",
      icon: <FaHeadset className="text-t3_blue" size={24} />,
    },
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col items-center pt-20 px-6 py-10 transition-colors duration-300 bg-white text-black dark:bg-black dark:text-white">
      <motion.h1
        className="text-3xl md:text-4xl font-bold text-t3_blue mb-6"
      ...
      >
        <p className="text-lg mb-4">
          At <span className="font-semibold text-t3_blue">T3 Sports</span>,
        ...
        {sections.map((section, index) => (
          ...
          >
            <button
              ...
              className="w-full flex items-center justify-between p-4 bg-t3_blue text-white dark:bg-[#1a1a1a] dark:text-white text-left font-semibold hover:bg-blue-600 transition-all duration-300"
            >
