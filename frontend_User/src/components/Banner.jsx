...
const Banner = () => {
  ...
  return (
    <div className="">
      ...
      <div className="flex items-center gap-8 absolute right-12 top-[80vh]">
        <div className="animate-slidein opacity-0 [--slidein-delay:700ms] text-white">
          <h2 className="text-7xl">200+</h2>
