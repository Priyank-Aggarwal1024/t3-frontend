...
const TermsConditions = () => {
  return (
    <div className="min-h-screen bg-white dark:bg-darkPrimary mx-auto p-4 md:px-12 relative text-black dark:text-white">
      <ScrollRestoration/>
      ...
      <section className="mb-6">
        ...
        <p className="mb-2 text-[14px]">
          By accessing and using this website or any other platform provided by T3Sports, you agree to be bound by these Terms and Conditions. It is your responsibility to review these Terms and Conditions periodically, as they may be updated or changed from time to time. For clarity, these Terms and Conditions apply to all services and products offered by T3Sports, including those with the name “T3Sports” or any other name we may use now or in the future.
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc list-inside ">
          <li><strong>T3Sports:</strong> Refers to the company and its various platforms and services, including but not limited to our website (www.T3Hockey.com) and any other digital platforms we may operate.</li>
          ...
          <li><strong>Website:</strong> Refers to www.T3Hockey.com.</li>
          <li><strong>Platform:</strong> Includes the T3Sports website and any other digital means we offer.</li>
          ...
          <li><strong>Service Providers:</strong> Entities that provide services to T3Sports and to whom we may disclose your data for specific purposes under a contractual agreement.</li>
        </ul>
      </section>
